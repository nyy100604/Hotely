...
const recommendationData = [
  {
    name: "Shanghai Hotel",
    image: "/assets/recommendation/hotel-1.png",
    location: "Shanghai China",
    desc: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto dolore laborum odit voluptas similique ratione totam, natus illo, ipsum dolorum voluptates ducimus corrupti mollitia perferendis et vel culpa ullam deserunt.",
    price: 40,
    testimonial: {
      message:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic obcaecati dolor suscipit, modi ipsam eveniet nulla nihil aut aliquid eius.",
      personName: "Robert Rene",
    },
  },
  {
    name: "Peaks Ledge",
    image: "/assets/recommendation/hotel-2.png",
    location: "Aspen, USA",
    desc: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto dolore laborum odit voluptas similique ratione totam, natus illo, ipsum dolorum voluptates ducimus corrupti mollitia perferendis et vel culpa ullam deserunt.",
    price: 80,
    testimonial: {
  ...
  },
  {
    ...
    image: "/assets/recommendation/hotel-3.png",
...
const Recommendation = () => {
  return (
    ...
    >
                ...
                <div className="flex flex-col xl:flex-row xl:pl-[135px] gap-y-12 xl:gap-y-0">
                  ...
                  <div className="order-1 xl:order-2 flex-1 flex justify-center xl:justify-end relative h-[634px]">
                    <div>
                      ...
                      />
                      <div className="bg-soft_green p-4 text-white text-center xl:text-left xl:max-w-[460px] xl:min-h-[212px] xl:absolute xl:bottom-0 xl:translate-x-1/2 xl:rounded-xl xl:px-10">
      ...
      <Image
        alt=""
        src="/assets/recommendation/pattern.svg"
        width={240}
        height={240}
