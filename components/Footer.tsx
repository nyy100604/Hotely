...
const Footer = () => {
  return (
    <footer className="bg-soft_green-secondary relative py-12 xl:pt-0">
      <div className="container mx-auto">
        ...
        >
          <div
            className="flex flex-col xl:flex-row bg-white p-8 rounded-xl
          ...
          >
            ...
            <div className="xl:w-[470px] mb-6 xl:mb-0">
              ...
              <p className="text-lg leading-9">
                ...
                Doloribus, aspernatur. Saepe dignissimos ea, officia quas
                dolorem accusantium corrupti vero similique?
              </p>
            </div>{" "}
            {/* navigation & contact  */}
